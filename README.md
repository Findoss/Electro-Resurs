# Электро Ресурс - производство электрощитов

Cобираем электрощиты с 2007 года на собственном производстве в Санкт-Петербурге.
...
- [Контент](./source/content/README.md)
- [Дизайн руководство (PDF)](./guide)
- [Дизайн сайта (Figma)](#)
- [Логотип](./source/logo)
- [Почта](./private/mails)
- [QR код](./qr_code)
